  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl shadow-navy/10 p-8 md:p-12">
      ...
      <p className="text-xs text-gray-400 mt-4 text-center">
        * Cash back processed through escrow. Subject to lender approval. 
      </p>
    </div>
  );
}
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-28 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-6 text-white/60 text-sm">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[#c9a84c] font-bold">$2M+</span>
                <span>Cash Back Paid</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#c9a84c] font-bold">200+</span>
      ...
      <section className="bg-[#f9f6f0] py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              { icon: '🏛️', label: 'CA Licensed Broker', sub: '' },
